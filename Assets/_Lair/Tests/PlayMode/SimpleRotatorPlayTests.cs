...
namespace Lair.Tests.PlayMode
{
    ...
    public class SimpleRotatorPlayTests
    {
        ...
        public IEnumerator MoveTowardsAngle_최단경로_회전_350도에서_10도()
        {
            ...
            SimpleRotator r = NewRotator(out GameObject go, speed: 540f, initialYaw: 350f);
        ...
        public IEnumerator TurnSpeed_느림_180_deg_per_sec_부분_회전만()
        {
            ...
            SimpleRotator r = NewRotator(out GameObject go, speed: 180f, initialYaw: 0f);
        ...
        public IEnumerator TurnSpeed_0_회전하지_않는다()
        {
            ...
            SimpleRotator r = NewRotator(out GameObject go, speed: 0f, initialYaw: 30f);
        ...
        public IEnumerator FaceDirection_호출_없으면_yaw_고정_유지()
        {
            ...
            SimpleRotator r = NewRotator(out GameObject go, speed: 540f, initialYaw: 123f);
